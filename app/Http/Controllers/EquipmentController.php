...
class EquipmentController extends Controller
{
    ...
    {
        return response()->json(
            Equipment::with(['type', 'brand', 'model', 'delivery.supplier', 'currentAssignment.employee'])
                ->get()
        );
    }
    ...
    {
        return response()->json(
            $equipment->load(['type', 'brand', 'model', 'delivery.supplier', 'assignments.employee'])
        );
    }
    ...
    public function update(Request $request, Equipment $equipment)
    {
        ...
        $equipment->update($request->only([
            'equipment_type_id', 'brand_id', 'model_id',
            'serial_number', 'delivery_id', 'condition', 'status',
        ]));
    ...
    {
        return Delivery::create($request->only([
            'voucher_no', 'invoice_no', 'supplier_id',
            'purchase_date', 'order_no', 'notes',
        ]));
    }
}